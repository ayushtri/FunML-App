...
public class FlowerIdentificationActivity extends ImageHelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomRemoteModel remoteModel = new CustomRemoteModel.Builder(new FirebaseModelSource
                .Builder("flowerDetectionModel").build()).build();
        ...
        RemoteModelManager.getInstance().download(remoteModel, downloadConditions)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(FlowerIdentificationActivity.this, "Try again later", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    protected void runClassification(Bitmap bitmap) {
        ...
        imageLabeler.process(inputImage).addOnSuccessListener(new OnSuccessListener<List<ImageLabel>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                e.printStackTrace();
                Toast.makeText(FlowerIdentificationActivity.this, "not working", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
